...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Активные заявки</h1>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
</div>
                                ...
                                <tr>
                                    ...
                                    <td class="project-actions text-right">
                                        ...
                                        <form action="{{route('reviewAppeal', $appeal->appeal_id)}}" method="POST">
                                            @csrf
                                            <button id="is_reviewed{{$appeal->appeal_id}}" type="submit" class="btn btn-success btn-sm delete-btn" href="#" onclick="reviewer.setClassToActive('is_reviewed{{$appeal->appeal_id}}')">
